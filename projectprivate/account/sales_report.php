                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   <form class="form-horizontal" action="rpt_sale_order_print.php" method="post" id="getOrderReportForm" target="_blank">
                                        ...
                                        <button type="submit"  id="generateReportBtn" class="btn btn-primary btn-flat m-b-30 m-t-30" target="blank">Generate Report</button>
                                    </form>
                                </div>
                            </div>
                        </div>
