		...
		<div class="invoice-box">
			<table cellpadding="0" cellspacing="0">
				<tr class="top">
					...
					<td colspan="6">
								<h2 style="margin:0 0 11px;"><b>Order Placement Report</b></h2> <b><?php echo"Date Report" ?></b><br />
...
//echo "$startdate-$enddate";
				 ...
				 include('php_action/db_connect.php');
								...
								$listsql = "call rptpurchaseorder('$startdate','$enddate'); ";
			...
			<table cellpadding="0" cellspacing="0">
					...
					$footsql = "call rptpofooter('$startdate','$enddate'); ";
