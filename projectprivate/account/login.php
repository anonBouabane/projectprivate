                    ...
                    <div class="col-md-4">
                        <div class="login-content ">
                            <div class="login-form">
                                <center><img src="./assets/uploadImage/Logo/person.png" style="width: 100px;"></center><br>
                                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" id="loginForm" class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="email" id="email" class="form-control" placeholder="email"  title="Invalid email address"required="">
